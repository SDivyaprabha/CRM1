...
namespace CRM
{
    public partial class frmCompTemplate : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void Execute(int argCompId)
        {
            m_iCompId = argCompId;
            ShowDialog();
        }
        ...
        void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (m_sExten == ".doc") sFileName = Application.StartupPath + "\\Temp.doc";
                else if (m_sExten == ".pdf") sFileName = Application.StartupPath + "\\Temp.pdf";
                else if (m_sExten == ".jpg") sFileName = Application.StartupPath + "\\Temp.jpg";
                bool bAns = false;
